...
<button style="font-size: 12px; background-color: #e7e7e7; color: black; float:left;" onclick="history.back()">Go Back</button>
	<form action="/returncar/findreturncarbyid" method="get">
		<h1>Find CarReturning ByCustomerId</h1>
		<div class="form">
			<table>
				<caption></caption>		
			<tr>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" placeholder="Car RegNo"
							name="carregno"  title="Enter the Carregno" pattern="^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$" title="Enter the CarRegno" required="true"></td>
							</tr>
